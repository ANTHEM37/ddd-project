...
CREATE
DATABASE IF NOT EXISTS ddd_example
...
(
    20
) NOT NULL DEFAULT 'ACTIVE' COMMENT '状态：ACTIVE-激活，INACTIVE-停用，LOCKED-锁定，DELETED-已删除',
...
VALUES ('test-user-1', 'testuser1', 'test1@example.com', 'password123', 'ACTIVE'),
